        ...
        <div className="grid items-center gap-12 px-8 py-16 lg:grid-cols-[1fr_320px] lg:px-16">
          ...
          <div className="flex flex-col items-end">
            ...
            <p className="mt-3 text-right font-mono text-xs tracking-[0.08em] text-muted-foreground">
              <span className="font-bold text-bright-blue">*</span>can't find
              your subject area,
              <br />
              contribute a guide
            </p>
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          {BLUE_CONCEPTS.map((concept) => (
            ...
            >
              ...
              <span className="mono-micro mt-auto inline-flex items-center tracking-[0.08em] text-muted-foreground uppercase group-hover:text-bright-blue">
                Read
                <ChevronRight className="h-3.5 w-3.5" />
              </span>
            </Link>
