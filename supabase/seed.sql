...
insert into public.guide_revisions (id, guide_id, title, summary, body, author_id, status, approved_at) values ('40000000-1000-0000-0000-000000000007', '30000000-1000-0000-0000-000000000007', 'Introduction to Machine Learning', 'Learn how machines find patterns in data and make predictions without being explicitly programmed.', '# What is Machine Learning?', '00000000-0000-0000-0000-000000000001', 'submitted', now()) on conflict do nothing;
...
insert into public.guide_revisions (id, guide_id, title, summary, body, author_id, status, approved_at) values ('40000000-1000-0000-0000-000000000009', '30000000-1000-0000-0000-000000000009', 'Introduction to Programming', 'Learn how to express instructions a computer can run, covering variables, control flow, and functions.', '# What is Programming?', '00000000-0000-0000-0000-000000000001', 'submitted', now()) on conflict do nothing;
